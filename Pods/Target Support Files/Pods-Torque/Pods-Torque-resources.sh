...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/WearnotchSDK/WearnotchSDK.framework/Visualiser.scnassets"
  install_resource "${PODS_ROOT}/WearnotchSDK/WearnotchSDK.framework/Firmware.notchassets"
fi
